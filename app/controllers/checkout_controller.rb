    ...
    def confirm_checkout
        if params[:province_name].present?
            ...
            customer = Customer.find_or_create_by(
              ...
              provinces_id: params[:province_name].id
            )
            ...
            redirect_to success_path # Redirect to a success page or another relevant action
          else
            # redirect_to checkout_index_path # Redirect back to the checkout page with an error message
          end
      end
    def success
